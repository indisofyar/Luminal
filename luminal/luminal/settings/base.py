"""
Django settings for luminal project.
...
SECRET_KEY = "django-insecure-qrm9+ojc0rs%jnq&!(+r+aj4h^q*i0h8xsbvs%z(l4kud-5a&j"
...
CRONJOBS = [
    ('* * * * *', 'luminal.luminal.cron_jobs.hello_world'),
]
